...
Named tunnels are **remotely managed** — configure ingress rules (which local services to expose) in the [Cloudflare dashboard](https://one.dash.cloudflare.com/) or via the API before running the tunnel.
