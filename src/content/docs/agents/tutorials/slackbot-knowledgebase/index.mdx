...
To make sure your users get the best answers, you will need to add the knowledge base tool to the AI model. The KnowledgeBaseTool is a tool that uses AutoRAG to retrieve information. You will need to create and configure a new AutoRAG instance. You can follow the [AutoRAG getting started](/autorag/get-started/) to create and configure a new AutoRAG instance.
